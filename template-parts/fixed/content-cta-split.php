<div class="relative bg-primary">
    <div class="relative h-80 overflow-hidden md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2">
        <img class="h-full w-full object-cover" src="<?php echo get_home_url() . '/wp-content/uploads/2023/08/Ingredients.webp'; ?>" alt="">
    ...
    <div class="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
        <div class="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
            <h2 class="text-base font-base font-semibold leading-7 text-indigo-400">Award winning support</h2>
            <p class="mt-2 text-3xl font-heading font-bold tracking-tight text-white sm:text-4xl">We’re here to help</p>
            <p class="mt-6  leading-7 text-gray-300">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et, egestas tempus tellus etiam sed. Quam a scelerisque amet ullamcorper eu enim et fermentum, augue. Aliquet amet volutpat quisque ut interdum tincidunt duis.</p>
            <div class="mt-8">
