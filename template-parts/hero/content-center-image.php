...
<div class="bg-gray-900">
    <div class="relative isolate overflow-hidden pt-14">
        <img src="<?php echo $hero['background_image']; ?>" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
        ...
        <!-- Container (Text) -->
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 z-10 relative">

            <!-- Callout -->
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div class="relative rounded-full px-3 py-1 bg-green-900/[.9]  leading-6 text-gray-100 ring-1 ring-white/10 hover:ring-white/20">
            ...
            <div class="text-center">
                ...
                <?php if ($hero['hero_heading']) { ?>
                    <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                        <?php echo $hero['hero_heading']; ?>
                    </h1>
                <?php } ?>

                <?php if ($hero['hero_description']) { ?>
