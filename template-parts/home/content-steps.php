<div class="bg-white py-24 sm:py-32">
    ...
    <div class="px-4 sm:px-0">
      <h3 class="text-xl font-semibold leading-7 text-gray-900">How it all works</h3>
      <p class="mt-1 max-w-2xl  leading-6 text-gray-500">Healthy, nutritious meals made easy</p>
    </div>
    <div class="mt-6 border-t border-gray-100">

      <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4 divide-x divide-gray-100 mt-8">
        <div class="px-4 py-6 sm:grid sm:grid-row-2 sm:gap-4 sm:px-0">
          <dt class="font-bold leading-6 text-gray-900">Getting started</dt>
        ...
        <div class="px-4 py-6 sm:grid sm:grid-row-2 sm:gap-4 sm:px-0">
          <dt class="font-bold leading-6 text-gray-900">Week 1</dt>
        ...
        <div class="px-4 py-6 sm:grid sm:grid-row-2 sm:gap-4 sm:px-0">
          <dt class="font-bold leading-6 text-gray-900">Weeks 2-4</dt>
        ...
        <div class="px-4 py-6 sm:grid sm:grid-row-2 sm:gap-4 sm:px-0">
          <dt class="font-bold leading-6 text-gray-900">Need help?</dt>
